...
class ReceitaController {
    ...
    def save() {
		...
		receitaInstance.valorContratoFinal = CalculaReceitaComParcelas(receitaInstance.valorContrato, receitaInstance.parcelas, receitaInstance.indice)
	...
	def CalculaReceitaComParcelas(float valorContrato,int parcelas, float indice){
		for(int i=0; i < parcelas; i++){
			valorContrato = valorContrato + (valorContrato * (indice/100))
		}
